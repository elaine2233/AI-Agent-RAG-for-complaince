...
| 3 | [docs/面试演示_图文版.html](docs/面试演示_图文版.html) | **图文版演示**：浏览器打开，键盘翻页，适合现场演示 |
| 4 | 运行 Demo | `python api_server.py` → 输入营销文案体验审核流程 |
| 5 | [docs/technology-selection.md](docs/technology-selection.md) | 技术选型决策：12大选型对比、候选分析、成本估算 |
| 6 | [docs/demo-production-gap.md](docs/demo-production-gap.md) | Demo→生产差异：29项差距分析、迁移路线图、检查清单 |
| 7 | [docs/api-reference.md](docs/api-reference.md) | API参考：54个端点、请求/响应示例 |
