...
AUTHOR_NAME = os.getenv("AUTHOR_NAME", "YINING SHI")
...
EXTRACT_MODEL = os.getenv("EXTRACT_MODEL", "qwen3.6-plus")
REASON_MODEL = os.getenv("REASON_MODEL", "qwen3.6-plus")
CROSSCHECK_MODEL = os.getenv("CROSSCHECK_MODEL", "qwen3.6-plus")
